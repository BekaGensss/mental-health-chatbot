...
<body class="antialiased font-sans bg-gray-50 flex items-center justify-center min-h-screen">
    <div class="text-center p-8 bg-white shadow-xl rounded-xl border-t-8 border-red-600">
        <h1 class="text-9xl font-extrabold text-red-700 tracking-wider">500</h1>
        ...
        <p class="text-gray-500 mt-6 text-lg">
            Terjadi kesalahan yang tidak terduga pada server. Tim kami telah diberitahu.
        </p>
